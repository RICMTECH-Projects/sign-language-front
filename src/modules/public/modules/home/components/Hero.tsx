...
export function Hero() {
  ...
  return (
    <header ref={container} className="relative w-full min-h-screen flex items-center justify-center pt-24 pb-16 px-6 md:px-12 overflow-hidden">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <div className="relative flex flex-col gap-6 md:pr-12 z-10">
          <svg className="absolute -top-16 -left-12 w-[150%] h-[150%] -z-10 opacity-20 pointer-events-none" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
             <path className="hero-svg-path" d="M10,200 Q150,50 300,100 T390,300" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
             <path className="hero-svg-path" d="M50,250 C100,500 250,50 350,280" stroke="var(--color-primary, #D65E45)" strokeWidth="3" strokeLinecap="round" />
          </svg>
          ...
          <h1 className="hero-text text-5xl md:text-6xl lg:text-7xl font-serif text-foreground leading-[1.1] tracking-tight">
            ...
            con las <span className="italic text-primary">manos</span> <br className="hidden sm:block" />
            y el corazón.
          </h1>
          
          <p className="hero-text text-lg md:text-xl text-foreground/80 max-w-prose leading-relaxed">
            Domina la Lengua de Señas de forma fácil y efectiva. Un curso diseñado para todos, sin importar tu experiencia previa, para fomentar una comunicación sin barreras.
          </p>
        ...
        <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px] flex justify-center lg:justify-end">
          <div className="hero-image relative w-full max-w-[480px] h-full rounded-4xl overflow-hidden shadow-2xl">
             <Image 
          ...
          <div className="hero-stat absolute bottom-12 left-0 sm:-left-8 bg-white/95 dark:bg-zinc-800/95 backdrop-blur-md p-6 rounded-2xl shadow-xl w-64 ring-1 ring-black/5 dark:ring-white/10 z-20">
            <h3 className="text-3xl font-bold text-primary mb-2">Una Habilidad</h3>
            <p className="text-sm text-foreground/80 leading-snug">
              Esencial en el mundo moderno. Mejora tus oportunidades y vuélvete más inclusivo.
            </p>
          </div>
        </div>
      </div>
